...
namespace ZeroGUI
{
	...
	void ColorPicker(char* name, FLinearColor* color)
	{
		...
		if (active_picker == elements_count)
		{
			...
			//0
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 0, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 0 / 255.f, 255 / 255.f, 255 / 255.f, 1.0f });
			...
			//1
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 1, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 0 / 255.f, 180 / 255.f, 255 / 255.f, 1.0f });
			...
			//2
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 2, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 0 / 255.f, 0 / 255.f, 255 / 255.f, 1.0f });
			...
			//3
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 3, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 125 / 255.f, 0 / 255.f, 255 / 255.f, 1.0f });
			...
			//4
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 4, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 255 / 255.f, 0 / 255.f, 255 / 255.f, 1.0f });
			...
			//5
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 5, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 255 / 255.f, 255 / 255.f, 135 / 255.f, 1.0f });
			...
			//6
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 6, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 255 / 255.f, 135 / 255.f, 0 / 255.f, 1.0f });
			...
			//7
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 7, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 255 / 255.f, 0 / 255.f, 0 / 255.f, 1.0f });
			...
			//8
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 8, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 115 / 255.f, 255 / 255.f, 80 / 255.f, 1.0f });
			...
			//9
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 9, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 0 / 255.f, 255 / 255.f, 0 / 255.f, 1.0f });
			...
			//10
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 10, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 0 / 255.f, 255 / 255.f, 255 / 255.f, 0.5f });
			...
			//11
			{
				ColorPixel(FVector2D{ pos.X + pixelSize.X * 11, pos.Y + pixelSize.Y * 0 }, pixelSize, color, FLinearColor{ 255 / 255.f, 0 / 255.f, 255 / 255.f, 0.5f });
