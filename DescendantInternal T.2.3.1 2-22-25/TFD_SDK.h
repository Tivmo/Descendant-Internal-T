...
#pragma pack(pop)
	...
	{
	public:
		uint8 Pad_InfoWidget[0x338];	// 0x04F8(0x0068)
		class UM1CharacterInfoWidgetComponent* InfoWidgetComponent;		// 0x0830(0x0008)
		uint8 Pad_CharacterAttribute[0x40];
		class UM1CharacterAttribute* CharacterAttribute;	 // 0x0878(0x0008)
		uint8 Pad_CharacterId[0x200];
		struct FM1TemplateId CharacterId;	// 0x0A80(0x0004)
	...
	{
	public:
		uint8 Pad_WeaponSlot[0x278];	// 0x0C70(0x01E0)
		class UM1WeaponSlotControlComponent* WeaponSlotControl;		// 0x0EE8(0x0008)
		uint8 Pad_PlayerName[0x88];
		class FString PlayerName;	// 0x0F78(0x0010)
		uint8 Pad_AM1Player_Class[0x302];
...
#pragma pack(push, 0x1)
	...
	{
	public:
		uint8 Pad_AM1Monster_Class[0x1E8]; //// 0x0C70(0x0008)
		static class UClass* StaticClass()
		{
...
#pragma pack(pop)
	...
	{
	public:
		uint8 Pad_RoundsComponent[0x30]; // 0x330
		class UM1WeaponRoundsComponent* RoundsComponent; // 0x0360(0x0008)
		uint8 Pad_PlayerOwner[0x78]; // 0x368
		class AM1Player* PlayerOwner; // 0x03E0(0x0008)
	public:
		static class UClass* StaticClass()
		{
...
#pragma pack(pop)
	...
	public:
		...
		uint8                                         Pad_AM1MissionTargetActor_Class[0x174];
	public:
		static class UClass* StaticClass()
		{
