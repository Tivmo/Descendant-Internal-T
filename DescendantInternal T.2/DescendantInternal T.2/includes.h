...
const TFD_SDK::FLinearColor ColorRed = { 0.6f, 0, 0, 0.75f };
const TFD_SDK::FLinearColor ColorBlue = { 0, 0, 1.0f, 0.50f };
const TFD_SDK::FLinearColor ColorDarkRed = { 0.25f, 0.0f, 0.0f, 1.0f };
...
const TFD_SDK::FLinearColor ColorSadPink = { 0.5f, 0.25f, 0.5f, 0.7f };
...
float cfg_LootVacuumRange = 240000.0f;
